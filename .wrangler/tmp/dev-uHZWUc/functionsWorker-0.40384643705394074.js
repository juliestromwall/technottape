...
// .wrangler/tmp/pages-2TI6ky/functionsWorker-0.40384643705394074.mjs
...
var clean = /* @__PURE__ */ __name2((v, max = 2e3) => typeof v === "string" ? v.trim().slice(0, max) : "", "clean");
var escapeHtml = /* @__PURE__ */ __name2((s) => s.replace(
  /[&<>"']/g,
  (c) => ({ "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" })[c]
), "escapeHtml");
...
__name2(tokenIsGood, "tokenIsGood");
...
var escapeHtml2 = /* @__PURE__ */ __name2((s) => String(s).replace(
  /[&<>"']/g,
  (c) => ({ "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" })[c]
), "escapeHtml");
...
// .wrangler/tmp/bundle-b3jX7y/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-b3jX7y/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.40384643705394074.js.map
